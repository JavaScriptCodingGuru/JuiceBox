...
const { client, getAllUsers, createUser, updateUser, getAllPosts, getUserById, createPost, getPostsByUser, updatePost, createTags, createPostTag, addTagsToPost } = require('./index');
